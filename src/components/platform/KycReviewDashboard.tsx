    ...
    <div className="space-y-6">
      ...
      {applications.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-dark-300 bg-white p-12 text-center dark:border-dark-700 dark:bg-dark-900">
          ...
          <h3 className="font-semibold text-dark-900 dark:text-white">Tidak ada aplikasi menunggu</h3>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="font-bold text-dark-900 dark:text-white truncate">{app.fullName}</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm">
          <div className="flex max-h-[92vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-dark-900">
            <div className="flex items-center justify-between border-b border-dark-200 px-4 py-3 dark:border-dark-700 sm:px-6">
              <div>
                <h3 className="text-lg font-bold text-dark-900 dark:text-white">Detail Registrasi Owner</h3>
              ...
              <div className="grid gap-5 md:grid-cols-[280px_1fr]">
                ...
                {selectedApp.ktmUrl && (
                  ...
                  >
                    <div className="flex items-center justify-between border-b border-dark-100 px-4 py-3 dark:border-dark-700">
                      <div>
                        <p className="text-sm font-semibold text-dark-900 dark:text-white">Foto KTM</p>
                        <p className="text-xs text-dark-500 dark:text-dark-400">{selectedApp.fullName}</p>
                      </div>
                      <span className="inline-flex items-center gap-1 text-xs font-medium text-primary-600">
                        <ZoomIn className="h-3.5 w-3.5" />
                ...
                <div className="space-y-4">
                  <div className="rounded-2xl border border-dark-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-800">
                    ...
                    <p className="mt-1 font-semibold text-dark-900 dark:text-white">{selectedApp.fullName}</p>
                  </div>
                  <div className="rounded-2xl border border-dark-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-800">
                  ...
                  <div className="rounded-2xl border border-dark-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-800">
                    ...
                    <p className="mt-1 font-semibold text-dark-900 dark:text-white">{selectedApp.universityName}</p>
                  </div>
                  <div className="rounded-2xl border border-dark-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-800">
                    <p className="text-xs font-semibold uppercase tracking-wide text-dark-400">Program Studi</p>
                    <p className="mt-1 font-semibold text-dark-900 dark:text-white">{selectedApp.programName}</p>
                  </div>
                  <div className="rounded-2xl border border-dark-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-800">
                    <p className="text-xs font-semibold uppercase tracking-wide text-dark-400">Nama Kelas</p>
                    <p className="mt-1 font-semibold text-dark-900 dark:text-white">{selectedApp.className}</p>
                  </div>
