...
export default function Loading({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#05070d]/85 px-4 backdrop-blur-xl">
      <div className="relative w-full max-w-md overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-br from-white/15 via-white/10 to-transparent p-8 text-center shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-2 text-sm text-gray-300">{subMessage}</p>
