...
export default function Loading({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-dark-50 dark:bg-dark-950 px-4 backdrop-blur-xl">
      <div className="relative w-full max-w-md overflow-hidden rounded-[28px] border border-dark-200/60 bg-white dark:border-dark-800 dark:bg-dark-900 p-8 text-center shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
