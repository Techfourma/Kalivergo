          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-dark-100 shrink-0">
              <div>
                ...
                <p className="text-xs text-dark-500 mt-0.5 truncate max-w-[300px]">
                  {taskTitle}
                </p>
              </div>
              <button
                ...
                className="h-8 w-8 flex items-center justify-center rounded-full hover:bg-dark-100 transition-colors text-dark-500"
              >
                <X className="h-4 w-4" />
              </button>
            </div>

            <div className="px-6 pt-4 pb-3 border-b border-dark-50 shrink-0 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={clearAll}
                    className="text-xs px-2.5 py-1 rounded-md bg-dark-100 text-dark-600 hover:bg-dark-200 transition-colors font-medium"
                  >
                    Hapus Semua
                  </button>
                </div>
                    ...
                    return (
                      ...
                      >
                        {isChecked ? (
                          ...
                          <Circle className="h-5 w-5 text-dark-300 shrink-0" />
                        )}
                        <div
            ...
            <div className="px-6 py-4 border-t border-dark-100 shrink-0 flex items-center justify-between bg-dark-50/50">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={isPending}
                  className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-semibold rounded-lg transition-all shadow-md hover:shadow-blue-500/30 disabled:opacity-60"
                >
                  {isPending ? (
