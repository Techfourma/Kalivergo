...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-dark-50 p-4 dark:bg-dark-950">
      ...
      <div className={`relative z-10 bg-dark-900 p-8 rounded-2xl shadow-2xl w-full max-w-md text-dark-100 border border-dark-700 ${showPopup ? "opacity-40 blur-sm" : ""}`}>
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-dark-700 bg-dark-800 text-dark-100 placeholder:text-dark-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50"
              placeholder="Masukkan nama lengkap Anda"
            />
          </div>

          <div>
            <label className="block text-sm font-medium text-dark-300 mb-1">NIM</label>
            <input
              type="text"
              name="nim"
          ...
          <div>
            <label className="block text-sm font-medium text-dark-300 mb-1">Email (Gmail)</label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className="block text-sm font-medium text-dark-300 mb-1">Nomor Telepon</label>
            <input
              type="tel"
              name="phone"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={isLoading || showPopup}
                minLength={6}
                className="w-full px-3 py-2 border border-dark-700 bg-dark-800 text-dark-100 placeholder:text-dark-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50 pr-10"
          ...
          <div>
            <label className="block text-sm font-medium text-dark-300 mb-1">Ulangi Password</label>
            <div className="relative">
              <input
          ...
          <div>
            <label className="block text-sm font-medium text-dark-300 mb-1">Masukan Nama Website Kelas Mu</label>
            <input
              type="text"
              name="customSlug"
          ...
          <div className="border-t border-dark-700 pt-4">
            <div>
              <label className="block text-sm font-medium text-dark-300 mb-1">Nama Universitas</label>
              <input
                type="text"
                name="universityName"
            ...
            <div className="mt-3">
              <label className="block text-sm font-medium text-dark-300 mb-1">Program Studi</label>
              <input
                type="text"
                name="programName"
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-dark-300 mb-2">Upload Selfie</label>
              <div className="flex items-center gap-4">
                {selfiePreview && (
                  <div className="relative w-20 h-20 rounded-lg overflow-hidden border border-dark-700">
                    <Image
                      src={selfiePreview}
                      alt="Selfie preview"
                      fill
                ...
                <label className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-dark-600 rounded-lg cursor-pointer hover:border-primary-500 transition-colors bg-dark-800">
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-dark-300 mb-2">Upload Foto KTM</label>
              <div className="flex items-center gap-4">
                {ktmPreview && (
                  <div className="relative w-20 h-20 rounded-lg overflow-hidden border border-dark-700">
                    <Image
