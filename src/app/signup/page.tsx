    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-950 via-dark-900 to-primary-950 p-4 relative">
      ...
      <div className={`bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md transition-opacity ${showPopup ? "opacity-40 blur-sm" : ""}`}>
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-dark-700 mb-1">Nomor Telepon</label>
            <input
              type="tel"
              name="phone"
              required
          ...
          <div className="border-t border-dark-200 pt-4">
            ...
            <div className="mt-3">
              <label className="block text-sm font-medium text-dark-700 mb-1">Nama Kelas</label>
              <input
                type="text"
                name="className"
                required
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <label className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-dark-300 rounded-lg cursor-pointer hover:border-primary-500 transition-colors bg-dark-50">
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-dark-700 mb-2">Upload Foto KTM</label>
              <div className="flex items-center gap-4">
                {ktmPreview && (
                  <div className="relative w-20 h-20 rounded-lg overflow-hidden border border-dark-200">
                    <Image
