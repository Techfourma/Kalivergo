...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-dark-50 p-4 dark:bg-dark-950">
      ...
      <div className={`relative z-10 bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md text-dark-900 border border-dark-200 dark:bg-dark-900 dark:text-dark-100 dark:border-dark-700 ${showPopup ? "opacity-40 blur-sm" : ""}`}>
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-dark-200 bg-white text-dark-900 placeholder:text-dark-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-100 dark:placeholder:text-dark-400"
          ...
          <div>
            <label className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-1">Nomor Telepon</label>
            <input
              type="tel"
              name="phone"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={isLoading || showPopup}
                minLength={6}
                className="w-full px-3 py-2 border border-dark-200 bg-white text-dark-900 placeholder:text-dark-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50 pr-10 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-100 dark:placeholder:text-dark-400"
                placeholder="Minimal 6 karakter"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-dark-400 hover:text-dark-600 dark:text-dark-400 dark:hover:text-dark-600"
                tabIndex={-1}
              >
          ...
          <div>
            <label className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-1">Masukan Nama Website Kelas Mu</label>
            <input
              type="text"
              name="customSlug"
          ...
          <div className="border-t border-dark-200 dark:border-dark-700 pt-4">
            <div>
              <label className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-1">Nama Universitas</label>
              <input
                type="text"
                name="universityName"
            ...
            <div className="mt-3">
              <label className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-1">Nama Kelas</label>
              <input
                type="text"
                name="className"
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-2">Upload Selfie</label>
              <div className="flex items-center gap-4">
                {selfiePreview && (
                  <div className="relative w-20 h-20 rounded-lg overflow-hidden border border-dark-200 dark:border-dark-700">
                    <Image
                      src={selfiePreview}
                      alt="Selfie preview"
                      fill
                ...
                <label className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-dark-300 rounded-lg cursor-pointer hover:border-primary-500 transition-colors bg-dark-50 dark:border-dark-600 dark:bg-dark-800">
                  <Upload className="w-5 h-5 text-dark-500 dark:text-dark-400" />
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-2">Upload Foto KTM</label>
              <div className="flex items-center gap-4">
                {ktmPreview && (
                  <div className="relative w-20 h-20 rounded-lg overflow-hidden border border-dark-200 dark:border-dark-700">
                    <Image
