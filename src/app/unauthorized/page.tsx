...
export default async function UnauthorizedPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0b0c16] text-white relative overflow-hidden font-sans">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative z-10 my-8">
        <div className="max-w-2xl w-full">
          {/* Main Card */}
          <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-10 shadow-2xl text-center overflow-hidden">
            {/* Top Badge */}
            ...
            <div className="relative mx-auto w-36 h-36 sm:w-44 sm:h-44 mb-6 flex items-center justify-center">
              ...
              <div className="relative z-10 w-full h-full bg-dark-900/90 border-2 border-white/20 rounded-2xl p-4 flex flex-col items-center justify-center shadow-inner group hover:scale-105 transition-transform duration-300">
            ...
            {/* Meme Description */}
            <div className="space-y-3 mb-8 text-gray-300 text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
              <p className="bg-white/5 p-4 rounded-xl border border-white/5 text-gray-200">
                🔒{" "}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/home"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-primary-500 to-accent-500 text-white font-semibold shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 hover:scale-105 transition-all duration-200"
              >
