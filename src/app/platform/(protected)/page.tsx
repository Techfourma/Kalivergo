  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <Link
          href="/platform/kyc"
          className="group rounded-2xl border border-dark-200 bg-white p-6 shadow-sm hover:border-primary-400 hover:shadow-md transition-all"
        >
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-dark-200 bg-white p-6 shadow-sm">
