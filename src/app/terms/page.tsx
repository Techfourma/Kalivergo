    ...
    <div className="min-h-screen bg-[#0a0a14] relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1">
          <div className="flex gap-8">
            ...
            <aside className="hidden lg:block w-64 flex-shrink-0">
              <div className="sticky top-8 bg-white/5 backdrop-blur-md rounded-2xl shadow-sm border border-white/10 p-6">
            ...
            <div className="lg:hidden fixed bottom-6 right-6 z-40">
              <button
                ...
                className="p-4 bg-accent-600 text-white rounded-full shadow-lg hover:bg-accent-700 transition-colors"
              >
            ...
            {mobileTocOpen && (
              <div className="lg:hidden fixed inset-0 z-50 bg-black/50" onClick={() => setMobileTocOpen(false)}>
                <div
                  className="absolute bottom-0 left-0 right-0 bg-[#0a0a14] rounded-t-2xl p-6 max-h-[70vh] overflow-y-auto border-t border-white/10"
                  onClick={(e) => e.stopPropagation()}
                >
                  <h3 className="font-semibold text-white mb-4">Daftar Isi</h3>
                  <nav className="space-y-1">
                    {sections.map((section) => {
                      const Icon = section.icon;
                      return (
                        <button
                          key={section.id}
                          onClick={() => scrollToSection(section.id)}
                          className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-sm text-gray-300 hover:bg-white/5 hover:text-white"
                        >
            ...
            <main className="flex-1 max-w-3xl">
              <div className="bg-white/5 backdrop-blur-md rounded-2xl shadow-sm border border-white/10 p-8 sm:p-12">
                {/* Acceptance */}
                <section id="acceptance" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm mt-1">Persetujuan Anda</p>
                    </div>
                  </div>
                ...
                <section id="membership" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">2. Keanggotaan</h2>
                      <p className="text-gray-400 text-sm mt-1">Siapa yang dapat menggunakan layanan</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={idx} className="flex items-start gap-3 p-4 bg-white/5 rounded-lg border border-white/5">
                ...
                <section id="responsibilities" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">3. Tanggung Jawab Pengguna</h2>
                      <p className="text-gray-400 text-sm mt-1">Kewajiban Anda sebagai pengguna</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                ...
                <section id="acceptable-use" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">4. Penggunaan yang Diterima</h2>
                      <p className="text-gray-400 text-sm mt-1">Cara penggunaan yang diperbolehkan</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                ...
                <section id="prohibited" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">5. Dilarang</h2>
                      <p className="text-gray-400 text-sm mt-1">Aktivitas yang tidak diperbolehkan</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                ...
                <section id="intellectual" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">6. Kekayaan Intelektual</h2>
                      <p className="text-gray-400 text-sm mt-1">Hak cipta dan kepemilikan</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                    <div className="space-y-4">
                      ...
                      <div className="border-l-4 border-green-500/50 pl-4">
                        <h3 className="font-semibold text-white mb-2">Larangan</h3>
                        <p className="text-sm text-gray-300">
                ...
                <section id="liability" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">7. Batasan Tanggung Jawab</h2>
                      <p className="text-gray-400 text-sm mt-1">Batas tanggung jawab kami</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                ...
                <section id="termination" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">8. Pengakhiran</h2>
                      <p className="text-gray-400 text-sm mt-1">Penghentian layanan</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                    <div className="space-y-4">
                      ...
                      <div className="border-l-4 border-primary-500/50 pl-4">
                        <h3 className="font-semibold text-white mb-2">Oleh Pengguna</h3>
                        <p className="text-sm text-gray-300">
                          Anda dapat menghentikan penggunaan layanan kapan saja dengan menghapus akun atau menghubungi kami.
                        </p>
                      </div>
                      <div className="border-l-4 border-accent-500/50 pl-4">
                        <h3 className="font-semibold text-white mb-2">Efek Pengakhiran</h3>
                        <p className="text-sm text-gray-300">
                ...
                <section id="changes" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">9. Perubahan Syarat</h2>
                      <p className="text-gray-400 text-sm mt-1">Update kebijakan</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                    <p className="mb-4">
                ...
                <section id="dispute" className="mb-12 scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">10. Penyelesaian Sengketa</h2>
                      <p className="text-gray-400 text-sm mt-1">Cara menyelesaikan masalah</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                    <div className="space-y-4">
                      <div className="border-l-4 border-cyan-500/50 pl-4">
                        <h3 className="font-semibold text-white mb-2">Hukum yang Berlaku</h3>
                        <p className="text-sm text-gray-300">
                          Syarat dan ketentuan ini tunduk pada dan ditafsirkan sesuai dengan hukum Republik Indonesia.
                        </p>
                      </div>
                      <div className="border-l-4 border-primary-500/50 pl-4">
                        <h3 className="font-semibold text-white mb-2">Musyawarah</h3>
                        <p className="text-sm text-gray-300">
                          Segala sengketa akan diselesaikan terlebih dahulu melalui musyawarah untuk mencapai mufakat.
                        </p>
                      </div>
                      <div className="border-l-4 border-accent-500/50 pl-4">
                        <h3 className="font-semibold text-white mb-2">Jalur Hukum</h3>
                        <p className="text-sm text-gray-300">
                ...
                <section id="contact" className="scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">11. Kontak</h2>
                      <p className="text-gray-400 text-sm mt-1">Hubungi kami</p>
                    </div>
                  </div>
                  <div className="text-gray-300 leading-relaxed">
                    <p className="mb-4">
        ...
        {showBackToTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 p-3 bg-accent-600 text-white rounded-full shadow-lg hover:bg-accent-700 transition-all z-30"
